...
class MFE_Elementor_Page {
    ...
    public function __construct() {
        ...
        $this->plugin_name = 'mask-form-elementor';
    ...
    private function load_dependencies() {
        ...
        if (!is_plugin_active( 'conditional-fields-for-elementor-form/class-conditional-fields-for-elementor-form.php' ) && !is_plugin_active( 'conditional-fields-for-elementor-form-pro/class-conditional-fields-for-elementor-form-pro.php') && !is_plugin_active( 'cool-formkit-for-elementor-forms/cool-formkit-for-elementor-forms.php')) {
            ...
            require_once MFE_PLUGIN_PATH . 'admin/class-mfe-admin.php';
            $plugin_admin = MFE_Admin::get_instance($this->get_plugin_name(), $this->get_version());
        }
